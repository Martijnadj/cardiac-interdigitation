...
public:
  ...
  */
  ...
  double CompactnessPixelCorner(int* bounds, int celltype); //overload compactness by computing compactness within a certain cropped area. And considering a certain cell type       
